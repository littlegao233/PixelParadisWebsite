(function () {
    ...
    var stageDom = document.getElementById((window._mrmcp || {})['script_id'] || "Mugeda_5d2ab1f79bbd0f695e3ab7e3")

    _mrmcp = (typeof _mrmcp == 'undefined') ? {} : _mrmcp;
_mrmcp['campaign_id'] = 'none';
_mrmcp['owner_id'] = '59ce147192b5792aee6d68ad';
_mrmcp['creative_id'] = '5d2ab1f79bbd0f695e3ab7e3';
...
_mrmcp['type'] = 'smart';
_mrmcp['title'] = 'MCBE像素彼岸服务器官网';
_mrmcp['build_number'] = parseInt('316');
_mrmcp['publish_time'] = 'Sun Mar 08 2020 17:37:35 GMT+0800 (CST)';
_mrmcp['last_modified'] = '';
_mrmcp['jsapi_config_url'] = '';
_mrmcp['track_bot'] = 'http://cd.mugeda.com/media/pages/track/track_20131030.html';
var version = _mrmcp['version'] = _mrmcp['version'] != null ? _mrmcp['version'] : '0.3.16';
...
Mugeda.loadProcessHandle.spinpercent = function (opt) {
    ...
    loadInfo.logoWidth = Math.round(((loadInfo.logoWidth || 128) / (opt.thisAni.width / this.dom.parentNode.offsetWidth) * 100)) / 100;
...
if(!window['_mrmcp']['loader']){
    var loadProcessHandleInstance = Mugeda['loadProcessHandleInstance'] = new Mugeda['loadProcessHandle']['spinpercent']({
        'loadInfo': {"textLoading":"0","messageText":"加载中...","messageSize":"20","messageColor":"rgba(203, 143, 255, 1)","progressColor":"rgba(182, 122, 255, 1)","progressBackground":"rgba(255, 255, 255, 0.5)","backgroundColor":"rgba(255, 255, 255, 0.5)","backgroundImage":(Array.isArray(_mrmcp.creative_path) ? _mrmcp.creative_path[0] : _mrmcp.creative_path ) + "images/59d372ad92b5797e8e1852fa.png","progressPosition":"5","logoWidth":"90","style":"spinpercent"},
        'thisAni': {
            'dom': null,
            'width': 320
        },
...
window['Mugeda']['Loader'] = function (dom, hasScript, _mrmcp) {
    ...
    if(!Mugeda['css3PlayerLoaded']) {
        var resPath = jsPath;
            ...
            loadRes(0, resPath + "mugeda_smart_renderer_inputbox" + version + ".js", [0], 1);
        
        loadRes(0, resPath + "mugeda_utils" + version + ".js", [0]);
        loadRes(1, jsPath + that.crid + ".js?publishTime=1583660255931", [], undefined, function(callback){
            var chk = function(){
...
Mugeda.Loader.prototype.start = function () {
    if (2 == Mugeda.css3PlayerLoaded) {
        ...
        Mugeda['startAnimation']("id_" + this.crid, true ? "actions_" + this.crid + ".js?publishTime=1583660255931" : "", a, this.resDir, this.name, null, this._mrmcp)
    }
    else {
